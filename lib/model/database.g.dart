...
class $ArchiveStudentsTable extends ArchiveStudents
    with TableInfo<$ArchiveStudentsTable, ArchiveStudent> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ArchiveStudentsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _rollnoMeta = const VerificationMeta('rollno');
  @override
  late final GeneratedColumn<String> rollno = GeneratedColumn<String>(
      'rollno', aliasedName, false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'archive_students';
  @override
  VerificationContext validateIntegrity(Insertable<ArchiveStudent> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('rollno')) {
  ...
  Set<GeneratedColumn> get $primaryKey => const {};
  @override
  ArchiveStudent map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $ArchiveStudentsTable createAlias(String alias) {
    return $ArchiveStudentsTable(attachedDatabase, alias);
  }
}

class ArchiveStudent extends DataClass implements Insertable<ArchiveStudent> {
  final String rollno;
  final String name;
  final DateTime? intime;
  final DateTime? outtime;
  ...
  ArchiveStudentsCompanion toCompanion(bool nullToAbsent) {
    return ArchiveStudentsCompanion(
      rollno: Value(rollno),
      name: Value(name),
      intime:
          intime == null && nullToAbsent ? const Value.absent() : Value(intime),
  ...
  factory ArchiveStudent.fromJson(Map<String, dynamic> json,
      {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return ArchiveStudent(
      rollno: serializer.fromJson<String>(json['rollno']),
  ...
  ArchiveStudent copyWithCompanion(ArchiveStudentsCompanion data) {
    return ArchiveStudent(
      rollno: data.rollno.present ? data.rollno.value : this.rollno,
      name: data.name.present ? data.name.value : this.name,
      intime: data.intime.present ? data.intime.value : this.intime,
  ...
  @override
  String toString() {
    return (StringBuffer('ArchiveStudent(')
          ..write('rollno: $rollno, ')
          ..write('name: $name, ')
          ..write('intime: $intime, ')
          ..write('outtime: $outtime, ')
...
class ArchiveStudentsCompanion extends UpdateCompanion<ArchiveStudent> {
  final Value<String> rollno;
  final Value<String> name;
  final Value<DateTime?> intime;
  final Value<DateTime?> outtime;
  final Value<String> department;
  final Value<int> rowid;
  const ArchiveStudentsCompanion({
    this.rollno = const Value.absent(),
    this.name = const Value.absent(),
    this.intime = const Value.absent(),
    this.outtime = const Value.absent(),
  ...
  ArchiveStudentsCompanion.insert({
    required String rollno,
    required String name,
    this.intime = const Value.absent(),
    this.outtime = const Value.absent(),
    ...
    this.rowid = const Value.absent(),
        ...
        name = Value(name),
        department = Value(department);
  static Insertable<ArchiveStudent> custom({
    Expression<String>? rollno,
    Expression<String>? name,
    Expression<DateTime>? intime,
    Expression<DateTime>? outtime,
  ...
  ArchiveStudentsCompanion copyWith(
      {Value<String>? rollno,
      Value<String>? name,
      Value<DateTime?>? intime,
      Value<DateTime?>? outtime,
  ...
  @override
  String toString() {
    return (StringBuffer('ArchiveStudentsCompanion(')
          ..write('rollno: $rollno, ')
          ..write('name: $name, ')
          ..write('intime: $intime, ')
          ..write('outtime: $outtime, ')
...
abstract class _$AppDb extends GeneratedDatabase {
  ...
  late final $ArchiveStudentsTable archiveStudents =
      $ArchiveStudentsTable(this);
  late final StudentDao studentDao = StudentDao(this as AppDb);
  late final ArchiveStudentDao archiveStudentDao =
      ArchiveStudentDao(this as AppDb);
  @override
...
typedef $$ArchiveStudentsTableCreateCompanionBuilder = ArchiveStudentsCompanion
    Function({
  required String rollno,
  required String name,
  Value<DateTime?> intime,
...
typedef $$ArchiveStudentsTableUpdateCompanionBuilder = ArchiveStudentsCompanion
    Function({
  Value<String> rollno,
  Value<String> name,
  Value<DateTime?> intime,
...
class $$ArchiveStudentsTableTableManager extends RootTableManager<
    _$AppDb,
    $ArchiveStudentsTable,
    ArchiveStudent,
    $$ArchiveStudentsTableFilterComposer,
    $$ArchiveStudentsTableOrderingComposer,
    $$ArchiveStudentsTableCreateCompanionBuilder,
    $$ArchiveStudentsTableUpdateCompanionBuilder> {
  $$ArchiveStudentsTableTableManager(_$AppDb db, $ArchiveStudentsTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          filteringComposer:
              $$ArchiveStudentsTableFilterComposer(ComposerState(db, table)),
          orderingComposer:
              $$ArchiveStudentsTableOrderingComposer(ComposerState(db, table)),
          updateCompanionCallback: ({
            Value<String> rollno = const Value.absent(),
            Value<String> name = const Value.absent(),
            Value<DateTime?> intime = const Value.absent(),
...
class $$ArchiveStudentsTableFilterComposer
    extends FilterComposer<_$AppDb, $ArchiveStudentsTable> {
  $$ArchiveStudentsTableFilterComposer(super.$state);
  ColumnFilters<String> get rollno => $state.composableBuilder(
      column: $state.table.rollno,
      builder: (column, joinBuilders) =>
          ColumnFilters(column, joinBuilders: joinBuilders));
...
class $$ArchiveStudentsTableOrderingComposer
    extends OrderingComposer<_$AppDb, $ArchiveStudentsTable> {
  $$ArchiveStudentsTableOrderingComposer(super.$state);
  ColumnOrderings<String> get rollno => $state.composableBuilder(
      column: $state.table.rollno,
      builder: (column, joinBuilders) =>
          ColumnOrderings(column, joinBuilders: joinBuilders));
...
class $AppDbManager {
  ...
  $$ArchiveStudentsTableTableManager get archiveStudents =>
      $$ArchiveStudentsTableTableManager(_db, _db.archiveStudents);
}

mixin _$StudentDaoMixin on DatabaseAccessor<AppDb> {
  $StudentsTable get students => attachedDatabase.students;
}
mixin _$ArchiveStudentDaoMixin on DatabaseAccessor<AppDb> {
  $ArchiveStudentsTable get archiveStudents => attachedDatabase.archiveStudents;
}
